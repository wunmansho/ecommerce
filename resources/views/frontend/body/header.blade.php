            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ route('wishlist') }}"><i class="icon fa fa-heart"></i>@if (session()->get('language') == 'hindi') इच्छा-सूची @else Wishlist @endif
                            </a></li>
                        <li><a href="{{ route('mycart') }}"><i class="icon fa fa-shopping-cart"></i>@if (session()->get('language') == 'hindi') मेरी गाड़ी @else My Cart @endif
                            </a></li>
                        <li><a href="{{ route('checkout') }}"><i class="icon fa fa-check"></i>@if (session()->get('language') == 'hindi') चेक आउट @else Checkout @endif
                            </a></li>
                ...
                <div class="cnt-block">
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown"
                                data-toggle="dropdown"><span class="value"> @if (session()->get('language') == 'hindi') भाषा: नहीं @else Language @endif </span><b
                                    class="caret"></b></a>
                            <ul class="dropdown-menu">
                            ...
                            <div class="control-group">
                                <ul class="categories-filter animate-dropdown">
                                    <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown"
                                            href="category.html">@if (session()->get('language') == 'hindi') श्रेणियाँ @else Categories @endif
                                            <b class="caret"></b></a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li class="menu-header">@if (session()->get('language') == 'hindi') संगणक @else Computer @endif
                                            </li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                    href="category.html">@if (session()->get('language') == 'hindi') - कपड़े @else - Clothing @endif
                                                </a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                    href="category.html">@if (session()->get('language') == 'hindi') - इलेक्ट्रॉनिक्स @else - Electronics @endif
                                                </a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                    href="category.html">@if (session()->get('language') == 'hindi') - जूते @else - Shoes @endif
                                                </a></li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                    href="category.html">@if (session()->get('language') == 'hindi') - घड़ियों @else - Watches @endif
                                                </a></li>
                                        </ul>
                                    </li>
                                </ul>
