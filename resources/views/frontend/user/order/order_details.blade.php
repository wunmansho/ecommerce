                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body" style="background: #E9EBEC;">
                                <table class="table">
                                    ...
                                    {{-- Begin references to the joins created in --}}
                                    {{-- order Model and Passed by --}}
                                    {{-- AllUserController.OrderDetails --}}
                                    <tr>
                                        <th>Division :</th>
                                    ...
                                    <tr>
                                        {{-- End references to the joins created in --}}
                                        {{-- order Model and Passed by --}}
                                        {{-- AllUserController.OrderDetails --}}
